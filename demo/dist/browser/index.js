...
(function(global, factory) {
                ...
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      ...
                      _context.next = 4;
                      return regenerator.awrap(exports.CameraAccess.getCameras());
                ...
                while (1) {
                  switch ((_context2.prev = _context2.next)) {
                    ...
                    case 7:
                      ...
                      mainCamera = exports.CameraAccess.adjustCamerasFromMainCameraStream(mediaStreamTrack, cameras);
  ...
  exports.Scanner =
    ...
    (function() {
      ...
      function Scanner() {
        ...
        if (exports.userLicenseKey == null) {
        ...
        this.engineWorker.postMessage({
          ...
          uaBrowserName: exports.BrowserHelper.userAgentInfo.getBrowser().name
        });
          ...
          value: function processImage(imageData) {
            ...
            return new promise$1(function(resolve, reject) {
              ...
              _this.eventEmitter.once(workResultEvent, function(workResult) {
                ...
                resolve(
                  new ScanResult(
                    workResult.scanResult.map(exports.Barcode.createFromWASMResult),
                    originalImageData,
                    _this.imageSettings
                  )
                );
  ...
  })(exports.Scanner || (exports.Scanner = {}));
  ...
  exports.BarcodePicker =
    ...
    (function() {
      function BarcodePicker(originElement, _ref) {
        ...
        if (scanner == null) {
          this.scanner = new exports.Scanner({
                  ...
                  while (1) {
                    switch ((_context2.prev = _context2.next)) {
                      ...
                      case 8:
                        _context2.next = 10;
                        return regenerator.awrap(
                          this.cameraManager.initializeCameraWithSettings(camera, cameraSettings)
                        );
                  ...
                  while (1) {
                    switch ((_context6.prev = _context6.next)) {
                      case 0:
                        ...
                        nextProcessingCallDelay = Math.max(
                          0,
                          1000 / this.targetScanningFPS - this.averageProcessingTime
                        );
